...
public class CategoryControllerTest {
    ...
    void addCategory_asAdmin_Success() throws Exception {
        CreateCategoryRequestDto categoryRequestDto = initCategoryRequest();
    ...
    void addCategory_asAdminWithInvalidRequest_BadRequest() throws Exception {
        CreateCategoryRequestDto categoryRequestDto = initInvalidRequest();
        String jsonRequest = objectMapper.writeValueAsString(categoryRequestDto);
        mockMvc.perform(
                post(CATEGORY_ENDPOINT)
                        .content(jsonRequest)
    ...
    void getAllCategories_asUser_ReturnListOfCategories() throws Exception {
        ...
        Set<CategoryDto> expected = Set.of(initFirstCategory(), initSecondCategory());
        Set<CategoryDto> actual = objectMapper.readValue(jsonResponse,
                new TypeReference<>() {});
        assertEquals(expected, actual);
    }
    ...
    void findCategoryById_withExistingId_ReturnCategory() throws Exception {
        ...
        CategoryDto expected = initFirstCategory();

        String jsonResponse = result.getResponse().getContentAsString();

        CategoryDto actual = objectMapper.readValue(jsonResponse,
                CategoryDto.class);
    ...
    void findBookByCategoryId_withExistingId_ReturnBook() throws Exception {
        ...
        List<BookDtoWithoutCategoryIds> actual = objectMapper.readValue(jsonResponse,
                new TypeReference<>() {});
    ...
    private CreateCategoryRequestDto initInvalidRequest() {
        return new CreateCategoryRequestDto("", "23");
    }

    private CreateCategoryRequestDto initCategoryRequest() {
        return new CreateCategoryRequestDto(
                "Test category name",
                "Test category description");
    }

    private BookDtoWithoutCategoryIds initFirstBook() {
    ...
    private BookDtoWithoutCategoryIds initSecondBook() {
        return new BookDtoWithoutCategoryIds(
                "Test book 3",
                "Test author 3",
                "978-1-23-456789-0",
    ...
    private CategoryDto initFirstCategory() {
    ...
    private CategoryDto initSecondCategory() {
        return new CategoryDto(
                2L,
                "test name 2",
                "test description 2"
