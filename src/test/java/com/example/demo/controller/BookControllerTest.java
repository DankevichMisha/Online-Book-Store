...
public class BookControllerTest {
    ...
    void createBook_ValidRequestDto_Success() throws Exception {
        ...
        BookDto expectedDto = initBookResponseDto(requestDto);
    ...
    void getAllBooks_AsUser_ReturnsListOfBooks() throws Exception {
        ...
        List<BookDto> expected = initListBookResponseDto();
    ...
    void getBookById_withExistingId_ReturnsBook() throws Exception {
        ...
        BookDto expected = initSecondBookResponseDto();
        BookDto actual = objectMapper.readValue(result.getResponse()
    ...
    void updateBook_ValidIdAndRequest_UpdatesAndReturnsBook() throws Exception {
        ...
        BookDto expected = initBookResponseDto(requestDto);
    ...
    void search_ValidParams_ReturnsListOfBooks() throws Exception {
        ...
        List<BookDto> expected = List.of(initSecondBookResponseDto());
        String jsonResponse = result.getResponse().getContentAsString();
    ...
    private BookDto initBookResponseDto(CreateBookRequestDto requestDto) {
        return new BookDto()
    ...
    private BookDto initFirstBookResponseDto() {
        return new BookDto()
    ...
    private BookDto initSecondBookResponseDto() {
        return new BookDto()
    ...
    private BookDto initThirdBookResponseDto() {
        return new BookDto()
    ...
    private BookDto initFourthBookResponseDto() {
        return new BookDto()
    ...
    private List<BookDto> initListBookResponseDto() {
        return List.of(
